...
Also, the estimate on household income shock could be overestimated, as I will discuss when I introduce @Schulhofer-Wohl2011.
...
However, this is still problematic since $\log X_{it}$ and $\eta_i$ can be positively correlated for the same reason as above.
This suggests that the estimate in @Kurosaki2011 might be biased as well, and this might be why @Schulhofer-Wohl2011 decides to obtain and control for $\lambda_t$ directly rather than using this transformation.
