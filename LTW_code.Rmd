...
## Transfers under dynamic limited commitment model with 3 states

In the numerical exercises so far, there are two states (or, 2 $\times$ 2 states) for income realizations.
Here, I consider the three-state model  (or, 3 $\times$ 3 states).
...
# Sequence of income shocks
income_realization <- seq(S)
income_realization_label <- c(
...
x_vec <- rep(NA, n + 1)
x_vec[1] <- 1
x_int_array_aut <- x_int_3_states
